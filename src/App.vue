<template>
	<div :class="containerClass" @click="onWrapperClick">
		...
		<div class="layout-main">
			...
			<AppBreadcrumb :darkMenu="darkMenu" @menu-color-change="onMenuColorChange"></AppBreadcrumb>

			<div class="layout-content">
				<router-view />
			</div>

			<AppConfig :layoutMode="layoutMode" @layout-change="onLayoutChange" @menu-color-change="onMenuColorChange"
...
export default {
    data() {
        return {
			...
			darkMenu: false,
            menu : [
				{label: 'Desktop', icon: 'pi pi-fw pi-home', to:'/'},
				{
					label: 'Template options', icon: 'pi pi-fw pi-home',
					items: [
						{
